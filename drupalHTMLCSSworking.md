...
const response = \$.getJSON(googleCal, displaySchedule);
                    ...
                    <div class="col-xs-12 col-lg-10 mb-eh">
                        ...
                        <div class="library-subpage-content">
                          <h2 id="Philosophy" class="subjectName">
Library Cheatsheets: PHILOSOPHY 
</h2> <p class="italics" style="font-family: 'Roboto Condensed', sans-serif;margin-top: -1rem;">Essential resources to get you started</p><hr>
...
(function () {
    ...
    1: [
      function (require, module, exports) {
        ...
        (async () => {
          ...
          const blocksForProduction = blocksForCheatsheet(
            dataForThisCheatsheet
          ...
          blocksForProduction.forEach((blockName) => {
            if (blockName === "ebsco_api_a9h") {
              ...
              createEbscoApiBlock(
                proxyPrepend,
                dataForThisCheatsheet.ebsco_api_a9h
            ...
            if (blockName === "citation_styles") {
              document.getElementById("citation_styles-heading").innerHTML =
                "Help with Citing"; // console.log("citation_stylesINIT");
            ...
            if (blockName === "primo_article_searches") {
              document.getElementById(
                "primo_article_searches-heading"
              ).innerHTML = "Articles from RMC Power Search";
              createPrimoArticlesBlock(
                dataForThisCheatsheet.primo_article_searches
              );
            }

            if (blockName === "primo_book_searches") {
              document.getElementById("primo_book_searches-heading").innerHTML =
                "Select Books from RMC Library"; // console.log("primo_book_searchesINIT");
      ...
      {
        "./modules/blockCreation/ancillary/dpla": 2,
        "./modules/blockCreation/core/citation_help": 3,
        "./modules/blockCreation/core/databases-by-subject": 4,
        "./modules/blockCreation/core/ebsco_api": 5,
        "./modules/blockCreation/core/primo_article_search": 6,
        "./modules/blockCreation/core/primo_book_search": 7,
        "./modules/blockCreation/core/primo_quick_search": 8,
        "./modules/blockCreation/core/weblinks": 9,
        "./modules/db/get-default-order": 10,
        "./modules/db/get-proxy-prepend": 11,
        "./modules/db/get-single-cheatsheet": 12,
        "./modules/db/library-cheatsheets-single-collection": 13,
        "./modules/db/library-cheatsheets-single-document": 14,
        "./modules/db/rmc-lib-data-single-collection": 17,
        "./modules/db/rmc-lib-data-single-document": 18,
        "./modules/domClasses/blockContent": 19,
        "./modules/domClasses/needUL": 20,
        "./modules/services/blocks-for-this-cheatsheet": 21,
        "./modules/services/buildBlockShell": 22,
      },
    ],
    2: [
      function (require, module, exports) {
          ...
          fetch(
            ...
            .then((json) => {
              ...
              if (json.docs[0].sourceResource.date)
                console.log(
                  "date",
                  json.docs[0].sourceResource.date[0].displayDate
                );
              ...
              json.docs.forEach((result) => {
                ...
                if (result.sourceResource.title)
                  title = result.sourceResource.title[0];
                else title = "";
                if (result.object) img = result.object;
                else img = "";
                if (result.sourceResource.type)
                  type = result.sourceResource.type[0];
                else type = "";
                if (result.sourceResource.creator)
                  creator = result.sourceResource.creator[0];
                else creator = "";
  ...
  */
      ...
      { "../../domClasses/blockContent": 19, "../../domClasses/needUL": 20 },
    ],
    3: [
      function (require, module, exports) {
      ...
      {
        "../../db/library-cheatsheets-single-document": 14,
        "../../domClasses/blockContent": 19,
      },
    ],
    4: [
      function (require, module, exports) {
        ...
        module.exports = async (proxyPrepend) => {
          ...
          prepDom.insertAdjacentHTML(
            "beforeend",
            "<div id='excellent_for'></div>"
          ...
          const whichPageWeWorkingWith = document.querySelector(".subjectName")
            .id;
...
<div class="wrap-collabsible" style="display:inline"  >
      ...
      {
        "../../db/rmc-lib-data-databases-EF": 15,
        "../../db/rmc-lib-data-databases-GF": 16,
        "../../db/rmc-lib-data-single-collection": 17,
        "../../domClasses/blockContent": 19,
        "../../domClasses/needUL": 20,
      },
    ],
    5: [
      function (require, module, exports) {
        ...
        module.exports = async (blockData) => {
          ...
          let getPrimoSearchesAndAppend = async (document) => {
            ...
            for (let i = 0; i < 5; i++) {
              ...
              const forAppending = `<li class="primo-article-li truncate"><a href="https://rocky-primo.hosted.exlibrisgroup.com/permalink/f/1e7lb5m/${resultBase.sourceid[0]}${resultBase.sourcerecordid[0]}"target="_blank">${resultBase.title}</a>`; // const forAppending = `<li class="primo-article-li"><a href="https://rocky-primo.hosted.exlibrisgroup.com/permalink/f/1e7lb5m/${resultBase.sourceid[0]}${resultBase.sourcerecordid[0]}"target="_blank">${resultBase.title}</a>From: ${resultBase.isPartOf}</li>`;
          ...
          let domFinishing = (searchTerms) => {
            let linksList = document.getElementById(
              "primo_article_searches-ul"
            );
            linksList.insertAdjacentHTML(
              "beforebegin",
...
*/
        ...
        module.exports = async (blockData) => {
          ...
          uidsWanted.forEach(async (uid) => {
            let bookResults = await rmcLibDataDocument(
              "primo-book-searches",
              uid
            ...
            var ourRandoms = getRandomNumbers(howManyWeWant, rawData.length); // console.log(bookResults.length, ourRandoms);
          ...
          function appendBook(bookData, iterator) {
            ...
            let baseDom = document.getElementById(
              "primo_book_searches-interior"
            );
   ...
   target="_blank">`;
    ...
    9: [
          ...
          rawData.forEach((i) => {
            i.AssociatedSubjects.forEach((q) => {
              if (q == topicForThisPage) {
                ...
                let weblinksContent = new BlockContent(
                  forDom,
                  "weblinks_block"
                );
      ...
      {
        "../../db/library-cheatsheets-single-collection": 13,
        "../../domClasses/blockContent": 19,
        "../../domClasses/needUL": 20,
      },
    ],
        ...
        module.exports = () => {
          ...
          return defaultOrderRef.get().then(function (doc) {
            if (doc.exists) {
              ...
              console.log(doc.data().order); // return doc.data().order

              let actualOrder = [];
              const keys = Object.keys(doc.data().orderObject); // look in object for the item with i and push that key to the array....
      ...
      function (require, module, exports) {
        class CheatsheetsBlockContent {
          ...
          getToAppending() {
            ...
            if (domsn == undefined)
              domsn = document.getElementById(`${this.name}`);
...
#primo_book_searches-interior .book-cover {
box-shadow: 0px 0px 2px darkgray;
}
#primo_book_searches-interior .new-books-li {
box-shadow: 1px 1px 3px lightgray;
padding: 1rem;
}
#primo_book_searches-interior ul li {
...
#ebsco_api_a9h-afterThangs,
primo_article_searches-afterThangs {
margin-top: 1rem;
}
...
#ebsco_api_a9h-beforeThangs,
#primo_article_searches-beforeThangs {
/_ border-left: 1px solid lightgray; _/
padding: 0px 0px 10px;
/_ padding-left: 10px; _/
}
.ebsco-li,
.primo-article-li {
...
/_ body {background: moccasin} _/
/_ .cheatsheet-block{border: 1px solid gray} _/
.cheatsheet-block-interior {
margin-left: 20px;
margin-bottom: 5rem;
}
#ebsco_api_a9h-interior ul li,
#primo_article_searches-interior ul li {
font-size: 14px !important;
margin-bottom: 5px;
}
#ebsco_api_a9h-interior ul,
#primo_article_searches-interior ul {
list-style-type: disc;
}
/_ #ebsco_api_a9h-wrap,
#primo_article_searches-wrap,
#databases-wrap,
#weblinks_block-wrap {
max-width: 47%;
float: left;
...
/_ FANCY PRELOADER CSSSSSSSS _/
/_ TRIPLE SPINNER https://codepen.io/camdenfoucht/pen/BVxawq_/
...
border-top: 4px solid #005934;
/_ border-top: 4px solid #FF5722; _/
...
right: 5px;
bottom: 5px;
/_ border-top-color: #FF9800; _/
border-top-color: #988b70;
...
right: 15px;
bottom: 15px;
border-top-color: #eee974;
/_ border-top-color: #FFC107; _/
...
/_ #primo_book_searches-interior ul li img {
max-width: 145px;
max-height: 215px;
} _/
.content {
...
div.row.mainContent{padding-top:0px;}
#todays-hours-block {
border-bottom: 1px solid #a49763;
border-radius: 5px; }
#todays-hours-block h3 {
margin-bottom: 0px; }
...
#todays-hours-details {
font-size: 14px; }

#power-search-1 h2 {
margin: 1rem 0px; }
#power-search-1 input {
align-self: center;
margin-left: 1.5rem; }
...
#databases-block-1 {
border: 1px solid #a49763;
border-radius: 5px;
margin-top: 4rem; }
#databases-block-1 h2 {
margin-bottom: 0px;
margin-top: -2rem;
background: white;
width: 170px;
...
#featured-special-collections-1 ul {
display: flex;
...
width: 100%;
padding: 5px;
background: rgba(82, 141, 75, 0.5); }

figcaption {
background: rgba(82, 141, 75, 0.5); }

figure {
border: 2px solid rgba(82, 141, 75, 0.5); }
...
#todays-hours-block-2 {
border: 1px solid #905836; }
#todays-hours-block-2 #todays-hours-actual-hours {
font-size: 2rem;
text-align: center; }
#todays-hours-block-2 h3 {
background: #905836;
padding: 1rem; }

#get-started2, #todays-hours2 {
margin-top: 5rem; }
...
#amu-search-bar-interior {
background: #d9dada;
height: 14rem;
display: flex;
align-items: center; }
#amu-search-bar-interior .question-svg {
width: 18px;
margin-left: 0px;
margin-right: 3px; }
#amu-search-bar-interior form a {
font-size: 13px; }

#primo-pak-searchwrap {
height: 110px; }
...
.info-pak-primo-long .info-pak-quotes {
color: black; }
.info-pak-primo-long .flextasm {
display: flex;
align-items: center;
height: 170px;
justify-content: center; }
.info-pak-primo-long .invert {
color: white;
font-family: "Roboto Condensed", sans-serif;
margin-bottom: 0px; }
.info-pak-primo-long .fa-info-circle {
font-size: 1.5rem; }
.info-pak-primo-long #featured-title {
color: white;
font-family: "Roboto Condensed", sans-serif;
font-weight: bold; }
...
.info-pak-square .invert {
color: white;
font-family: "Roboto Condensed", sans-serif;
margin-bottom: 0px; }
.info-pak-square .fa-info-circle {
font-size: 1.5rem; }
.info-pak-square #featured-title {
color: white;
font-family: "Roboto Condensed", sans-serif;
font-weight: bold; }
.info-pak-square .row {
...
.info-pak-square-2 .flextasm {
display: flex;
align-items: center;
height: 170px;
justify-content: center; }
.info-pak-square-2 .invert {
color: white;
font-family: "Roboto Condensed", sans-serif;
margin-bottom: 0px; }
.info-pak-square-2 .fa-info-circle {
font-size: 1.5rem; }
.info-pak-square-2 #featured-title {
color: white;
font-family: "Roboto Condensed", sans-serif;
font-weight: bold; }

.info-pak-square-3 .top-pak,
.info-pak-square-3 .side-pak {
background-color: goldenrod;
background-image: url(data:image/png;base64,); }
.info-pak-square-3 .flextasm {
display: flex;
align-items: center;
height: 130px;
justify-content: center; }
...
text-align: center;
padding-top: 2rem; }
.info-pak-square-3 .top-pak div {
margin: 2rem auto;
max-width: 445px;
display: block; }
.info-pak-square-3 .invert {
color: #fff;
font-weight: bold;
font-family: "Roboto Condensed", serif;
margin-bottom: 10px; }
.info-pak-square-3 .fa-info-circle {
font-size: 1.5rem; }
.info-pak-square-3 #featured-title {
color: white;
font-family: "Roboto Condensed", sans-serif;
font-weight: bold;
font-size: 1.9rem; }
.info-pak-square-3 #db-feature-title {
font-size: 1.9rem; }
.info-pak-square-3 #databases-ul {
margin: 0px;
padding-left: 0px; }
.info-pak-square-3 #databases-ul li {
margin: 1rem 0px; }
.info-pak-square-3 #databases-ul li button {
width: 150px; }
.info-pak-square-3 #databases-ul li select {
width: 150px;
text-align: center; }

.info-pak-square-all-vertical .top-pak,
.info-pak-square-all-vertical .side-pak {
background-color: #836f44;
background-image: url(data:image/png;base64,); }
.info-pak-square-all-vertical .flextasm {
display: flex;
align-items: center;
height: 130px;
justify-content: center; }
...
text-align: center;
padding-top: 2rem; }
.info-pak-square-all-vertical .top-pak div {
margin: 2rem auto;
max-width: 445px;
display: block; }
.info-pak-square-all-vertical .invert {
color: #fff;
margin-bottom: 10px; }
.info-pak-square-all-vertical .fa-info-circle {
font-size: 1.5rem; }
.info-pak-square-all-vertical #featured-title {
color: white;
font-family: "Roboto Condensed", sans-serif;
font-size: 1.9rem;
text-align: center; }
.info-pak-square-all-vertical #db-feature-title {
font-size: 1.9rem;
text-align: center;
display: block; }
.info-pak-square-all-vertical #databases-ul {
margin: 0px;
padding-left: 0px; }
.info-pak-square-all-vertical #databases-ul li {
margin: 1rem 0px;
display: inline; }
.info-pak-square-all-vertical #databases-ul li button, .info-pak-square-all-vertical #databases-ul li select {
width: 175px;
font-size: 1.4rem;
height: 37px;
text-align: center;
display: inline-block; }
.info-pak-square-all-vertical #databases-ul, .info-pak-square-all-vertical #db-featured {
padding: 1.5rem; }
.info-pak-square-all-vertical #db-featured {
margin-bottom: 1rem; }
...
.info-pak-cheatsheets {
color: #111;
background: #905836; }
.info-pak-cheatsheets ul {
padding-left: 0px;
margin-bottom: 0px; }
.info-pak-cheatsheets .flextasm {
display: flex;
align-items: center;
height: 140px;
justify-content: center; }
.info-pak-cheatsheets .invert {
color: white;
font-family: "Roboto Condensed", sans-serif;
margin-bottom: 0px; }
.info-pak-cheatsheets .fa-info-circle {
font-size: 1.5rem; }
.info-pak-cheatsheets #featured-title {
color: white;
font-family: "Roboto Condensed", sans-serif;
font-weight: bold; }
...
.info-pak-primo-pic {
padding: 4rem 0px;
background-image: url("/img/bookshelf-1.jpg");
background-color: #396847; }
.info-pak-primo-pic .primo-pic-content-wrap {
background: rgba(144, 88, 54, 0.95); }
.info-pak-primo-pic .info-pak-quotes {
color: black; }
.info-pak-primo-pic .flextasm {
display: flex;
align-items: center;
height: 170px;
justify-content: center; }
.info-pak-primo-pic .invert {
color: white;
font-family: "Roboto Condensed", sans-serif;
margin-bottom: 0px; }
.info-pak-primo-pic .fa-info-circle {
font-size: 1.5rem; }
.info-pak-primo-pic #featured-title {
color: white;
font-family: "Roboto Condensed", sans-serif;
font-weight: bold; }
...
.research-services-1 h2 {
border-bottom: 1px solid #2d5f34; }
.research-services-1 ul li a {
background: #396847;
padding: 1rem;
border-radius: 5px;
width: 240px;
...
background-image: url(data:image/png;base64,); }
#nav-2 #library-nav-links {
align-self: center;
font-family: "Roboto Condensed", sans-serif; }
#nav-2 #library-nav-links ul {
display: flex;
flex-wrap: wrap; }
#nav-2 #library-nav-links ul li {
font-size: 1.8rem;
display: flex;
flex-wrap: nowrap;
cursor: pointer;
height: 46px; }
#nav-2 #library-nav-links ul li .fa-chevron-right {
font-size: 1.2rem;
color: #905836;
margin-right: 3px;
margin-top: 7px; }
#nav-2 #library-nav-links ul li :hover,
#nav-2 #library-nav-links ul li :focus {
border-bottom: 3px solid #00582c;
color: inherit; }
#nav-2 #library-nav-links ul li a {
color: #111;
text-transform: uppercase; }

#hours-teensy-for-nav {
display: flex;
align-items: center;
justify-content: center;
background-image: url(data:image/png;base64,);
background-color: rgba(57, 104, 71, 0.1);
text-align: center;
padding: 1rem;
margin-top: 1.5rem; }
#hours-teensy-for-nav #hours-2,
#hours-teensy-for-nav #hours-1 {
font-family: "Roboto Condensed", sans-serif;
color: #111; }
#hours-teensy-for-nav #hours-1 {
text-transform: uppercase; }
#hours-teensy-for-nav .fa-clock {
color: #111; }

.info-pak-primo-square .col-xs-12 {
background-color: #396847;
background-image: url(data:image/png;base64,); }
.info-pak-primo-square .info-pak-quotes {
color: black;
text-align: center;
font-size: 1.3rem; }
.info-pak-primo-square .flextasm {
display: flex;
align-items: center;
height: 110px;
justify-content: center; }
.info-pak-primo-square .invert {
color: white;
font-family: "Roboto Condensed", sans-serif;
margin-bottom: 0px; }
.info-pak-primo-square .fa-info-circle {
font-size: 1.5rem; }
.info-pak-primo-square #featured-title {
color: white;
font-family: "Roboto Condensed", sans-serif;
font-weight: bold; }
...
.info-pak-primo-square-vertical-tri .top-pak {
text-align: center;
padding-top: 2rem; }
.info-pak-primo-square-vertical-tri .top-pak div {
margin: 2rem auto;
max-width: 445px;
display: block;
font-size: 16px; }
.info-pak-primo-square-vertical-tri .col-xs-12 {
background-color: #386238;
background-image: url(data:image/png;base64,); }
.info-pak-primo-square-vertical-tri #primo-pak-searchwrap {
height: 167px; }
.info-pak-primo-square-vertical-tri .info-pak-quotes {
color: 111;
text-align: center;
font-size: 1.3rem; }
.info-pak-primo-square-vertical-tri .info-pak-quotes span {
max-width: 395px;
display: block;
margin: 0 auto; }
.info-pak-primo-square-vertical-tri .invert {
color: #fff;
font-family: "Roboto Condensed", serif;
margin-bottom: 10px; }
.info-pak-primo-square-vertical-tri .fa-info-circle {
font-size: 1.5rem; }
.info-pak-primo-square-vertical-tri #featured-title {
color: white;
font-family: "Roboto Condensed", sans-serif;
font-weight: bold; }
...
/_ stop the glowing blue shadow _/
...
padding-left: 0px; }
.index-content .container .no-left {
padding-left: 0px; }

.featured-collections-cards-wrap .row {
margin-top: 20px; }

.featured-collections-cards-wrap a {
color: black; }

.featured-collections-cards-wrap .card {
background-color: #FFFFFF;
padding: 0;
box-shadow: 0 1px 1px 0 rgba(0, 0, 0, 0.14);
margin-bottom: 1rem; }

.featured-collections-cards-wrap .card:hover {
color: black; }

.featured-collections-cards-wrap .card img {
width: 100%;
max-height: 19rem; }

.featured-collections-cards-wrap .card h4 {
margin: 20px;
font-family: "Roboto Condensed", sans-serif;
color: #111;
text-transform: uppercase; }

.featured-collections-cards-wrap .card p {
margin: 20px;
opacity: 0.65;
font-size: 14px; }

.featured-collections-cards-wrap .blue-button {
width: 145px;
-webkit-transition: background-color 1s , color 1s;
/_ For Safari 3.1 to 6.0 _/
...
.featured-collections-cards-wrap .blue-button:hover {
...
#databases-AZ .fa-external-link-alt,
#databases-AZ .fa-link {
font-size: 1.1rem;
margin-left: 0.5rem;
...
.database-li .database-description {
font-size: 1.5rem;
max-width: 800px;
...
margin-right: 0.5rem; }
.actual-az-links li a {
padding: 1rem 1.1rem;
border-radius: 3px;
text-align: center;
font-size: 1.8rem;
color: #333; }
.actual-az-links li a:hover, .actual-az-links li a:focus {
background-color: #ebefec; }
...
#databases-ul li {
margin: 1rem 0px; }
#databases-ul li button {
width: 200px; }
#databases-ul li select {
width: 200px;
text-align: center; }
...
#todays-hours-block-3 {
display: flex;
align-items: center;
height: 100px; }
#todays-hours-block-3 h3 {
margin-bottom: 0px !important; }
#todays-hours-block-3 .todays-hours-actual-hours {
font-size: 1.9rem;
margin: 5px 1rem 0px; }
...
#info-pak-databases-long {
color: #222;
background: #baab80; }
#info-pak-databases-long .flextasm {
display: flex;
align-items: center;
height: 170px;
justify-content: center; }
#info-pak-databases-long .invert {
color: white;
font-family: "Roboto Condensed", sans-serif;
margin-bottom: 0px; }
#info-pak-databases-long .fa-info-circle {
font-size: 1.5rem; }
#info-pak-databases-long #featured-title {
color: white;
font-family: "Roboto Condensed", sans-serif;
font-weight: bold; }
...
width: 28rem;
float: right; }
#hours-teensy #hours-2,
#hours-teensy #hours-1 {
font-family: "Roboto Condensed", sans-serif; }
#hours-teensy #hours-1 {
font-weight: bold; }
...
width: 100%;
height: 274px;
background-image: url("/img/img-bar-2.jpg");
background-color: #396847; }
.picture-bar .picture-bar-quote {
background-color: rgba(255, 255, 255, 0.5);
font-size: 3rem;
max-width: 70rem;
padding: 2rem; }
.picture-bar .picture-bar-quote .fa-quote-right,
.picture-bar .picture-bar-quote .fa-quote-left {
font-size: 2rem !important; }
.picture-bar .picture-bar-quote .attribution {
font-size: 1.5rem;
font-style: italic;
font-family: "Roboto Condensed", sans-serif; }
...
.featured-special-collections-text {
...
color: #111;
background-image: url(data:image/png;base64,); }
#greenlong-narrow .fa-envelope,
#greenlong-narrow .fa-phone,
#greenlong-narrow .fa-grin {
font-size: 1.3rem; }
...
font-family: "Roboto Condensed", sans-serif;
color: #00582c; }
#quick-links-greeny .fa-compass {
color: #00582c; }
#quick-links-greeny .mb-1r {
margin-bottom: 1rem; }

#quick-links-greeny-new {
background-image: url(data:image/png;base64,);
background-color: rgba(57, 104, 71, 0.1);
margin-bottom: 1rem;
text-align: left;
...
#index-tri #db-feature-title {
font-size: 1.6rem !important;
color: #222; }

#index-tri #primo-pak-searchwrap {
margin-top: -1rem; }
...
#excellent_for > li.alphabet-li,
#good_for > li.alphabet-li {
margin-top: 4rem; }
...
align-self: center;
font-family: "Roboto Condensed", sans-serif; }
#library-nav-links .dropdown-menu > li > a:focus, #library-nav-links .dropdown-menu > li > a:hover {
background-image: url(data:image/png;base64,); }
#library-nav-links ul li {
font-size: 1.8rem;
padding: 1rem;
padding: 1rem; }
#library-nav-links ul li .fa-chevron-right {
font-size: 1.2rem;
color: #905836;
margin-right: 3px;
margin-top: 7px; }
#library-nav-links ul li .dropdown-toggle {
text-transform: uppercase; }
#library-nav-links ul li .dropdown-toggle:hover, #library-nav-links ul li .dropdown-toggle:focus {
background-image: url(data:image/png;base64,); }
#library-nav-links ul li a {
color: #111; }
...
font-family: "Roboto Condensed", sans-serif; }
.library-navbar .dropdown .fa-chevron-right {
transition: all .2s;
transition-timing-function: ease; }
.library-navbar .dropdown.open .fa-chevron-right {
transform: rotate(90deg); }
.library-navbar .navbar-toggle {
border: none;
background: transparent !important; }
.library-navbar .navbar-toggle:hover {
background: transparent !important; }
.library-navbar .navbar-toggle .icon-bar {
width: 22px;
transition: all 0.2s; }
.library-navbar .navbar-toggle .top-bar {
transform: rotate(45deg);
transform-origin: 10% 10%; }
.library-navbar .navbar-toggle .middle-bar {
opacity: 0; }
.library-navbar .navbar-toggle .bottom-bar {
transform: rotate(-45deg);
transform-origin: 10% 90%; }
.library-navbar .navbar-toggle.collapsed .top-bar {
transform: rotate(0); }
.library-navbar .navbar-toggle.collapsed .middle-bar {
opacity: 1; }
.library-navbar .navbar-toggle.collapsed .bottom-bar {
transform: rotate(0); }
.library-navbar .icon-bar {
background-color: #00582c !important; }
.library-navbar .navbar-toggle {
color: #333;
font-size: 14px; }
.library-navbar .navbar-toggle .left {
margin-top: 5px; }
.library-navbar .navbar-collapse.in {
padding-top: 0px; }
.library-navbar .navbar-header {
...
.container-fluid.ehhhh {
background-color: #ebefec;
background-image: url(data:image/png;base64,); }
.container-fluid.ehhhh .dropdown-menu {
...
.show-below-large {
display: none; } }
.library-hours-for-real {
padding-left: 40px !important; }
.library-hours-for-real li {
list-style-type: square; }
...
#equestrian-periodicals li, #equestrian-books li {
display: inline-block;
margin-right: 3rem; }
#equestrian-periodicals li img, #equestrian-books li img {
width: 150px;
height: 190px; }

#off-campus-databases-info-block {
background-color: #cae3b1;
padding: 2rem 1rem 1px !important; }
#off-campus-databases-info-block .fa-info-circle {
font-size: 18px; }
#off-campus-databases-info-block p {
font-size: 16px;
font-family: "Roboto Condensed", sans-serif;
color: #222; }
...
#index-tri::before, #library-nav-links::before, #bs-example-navbar-collapse-1::before, #featured-title::before,
span::before {
content: none !important; }

#library-things \*::before {
content: none; }
...
#block-system-main-menu {font-size:14px!important}
